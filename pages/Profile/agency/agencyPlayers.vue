<template>
	<view class="container">
				...
				<view class="app-box-item">
					...
					<view class="app-box-item-r">
						<view class="app-box-item-title">
							...
							<text class="active" @click="jumpDetail">统计</text>
						</view>
			...
			<view class="app-head-bottom">
				...
				<view class="app-head-info">
					<view class="info-item">
						<text class="text">今日完成/个</text>
						<text class="cont">{{detail.two_count}}</text>
					</view>
					<view class="info-item">
						<text class="text">今日赚得/元</text>
		...
		<view class="app-title">
			...
			<view class="Title-text">今日完成任务</view>
		</view>
		...
		<view class="app-context">
			...
			<block v-else>
				<z-empty text="暂无今日完成任务数据~"></z-empty>
			</block>
		</view>
	</view>
</template>
...
<script>
	import { teamDetail } from '@/network/profile-api'
	...
	export default {
		...
		methods: {
			async getTeamDetail() {
				try{
					let res = await teamDetail(this.params)
			...
			moreTeamList() {
				teamDetail(this.params).then(res => {
